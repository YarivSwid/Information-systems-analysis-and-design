...
namespace BiotestCompany
{
    static class Program
    {
        ...
        public static System.Collections.Generic.List<SupplierOrder> SO = new List<SupplierOrder>();
        ...
        public static void init_contact()
        {
            ...
            while (rdr.Read())
            {
                Contact C = new Contact(rdr.GetValue(0).ToString(), int.Parse(rdr.GetValue(1).ToString()), rdr.GetValue(2).ToString(), false);
                contacts.Add(C);
            }
        }
